...
public class Cenario_1_Minimizar_ConjuntoUnitTests {
    ...
    void Dado_Um_AFN_Deve_Ser_Separado_EM_Grupo_Mostando_Esse_Grupos(){
        ...
        estadosEsperados.add(new Estado(2, "q2", true, true));
   ...
   @Test
    void Dado_Um_AFN_Deve_Mostar_As_Transações_Criadas(){
       ...
       transicaosEsperadas.add( new Transicao(1, 1, "a"));
