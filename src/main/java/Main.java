...
public class Main {
    ...
    static ArrayList<ListaMinimizacao> list = new ArrayList<>();
    ...
    public static void equivalente(){
       for (ListaMinimizacao lista : list) {
    ...
    public static void acharIguais(Transicao transicao1, Transicao transicoes2){
    ...
    public static void criarLista(Automato afd){
